...
<!-- Post Create Box ================================================= -->
    <div class="create-post">
        <div class="row">
            ...
            <textarea name="texts" id="exampleTextarea" cols="500" rows="1" class="form-control" placeholder="Write what you wish"></textarea>
            </div>
        </div>
...
================================================= -->
    <div class="post-content">
        <img src="images/post-images/ngo-registration-image.png" alt="post-image" class="img-responsive post-image" />
...
================================================= -->
    <div class="post-content">
                    <div class="video-wrapper">
                        <video class="post-video" controls> <source src="demo video" type="video/mp4"> </video>
                    </div>
        <div class="post-container">
...
================================================= -->
    <div class="post-content">
        <img src="images/post-images/difference-between-SHG-and-NGO_.jpg" alt="post-image" class="img-responsive post-image" />
        <div class="post-container">
...
================================================= -->
    <div class="post-content">
        <img src="images/post-images/NGO-registration.jpg" alt="" class="img-responsive post-image" />
        <div class="post-container">
